          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-zinc-400 mt-2">
                Click a team logo to eliminate or restore them.
              </p>
            </div>
                        ...
                        <div key={division}>
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                            {divisionTeams.map((team) => {
                              const isEliminated = eliminated[team.abbr];
  
                              return (
                                <button
                                  key={team.abbr}
                                  onClick={() => toggleTeam(team.abbr)}
                                  className="relative group bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-2xl p-4 flex flex-col items-center justify-center transition-all duration-200 hover:scale-105 overflow-hidden"
                                >
                                  <div
